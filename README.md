...
(图片效果来自 [WeChatSetu插件](https://github.com/meteorOSS/WeChatSetu)

## 支持功能

- 消息回复(好友，群组),文本,视频,文件,语音发送
- 获取用户信息，设置备注等
- 用java编写扩展插件，打包以jar载入运行 详见 [编写wechatbc插件](https://github.com/meteorOSS/WeChatBc/wiki/%E7%BC%96%E5%86%99WeChatBc%E6%8F%92%E4%BB%B6)
